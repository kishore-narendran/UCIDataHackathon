...
for row in reader:
    ...
    out_record = [
        ...
        int(row[13]) if is_real(row[13]) else None,
        int(row[14]) if is_real(row[14]) else None,
        int(row[15]) if is_real(row[15]) else None,
        int(row[16]) if is_real(row[16]) else None,
        int(row[17]) if is_real(row[17]) else None,
        int(row[18]) if is_real(row[18]) else None,
        int(row[19]) if is_real(row[19]) else None,
        int(row[20]) if is_real(row[20]) else None,
        int(row[21]) if is_real(row[21]) else None,
        int(row[22]) if is_real(row[22]) else None,
        int(row[23]) if is_real(row[23]) else None,
        int(row[24]) if is_real(row[24]) else None,
    ]
    ...
    # ]
    if out_record[0] == -1 or out_record[3] == -1:
        continue
