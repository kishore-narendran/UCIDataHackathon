...
for row in reader:
    ...
    out_record = [
        ...
        float(row[13]) if is_real(row[13]) else None,
        float(row[14]) if is_real(row[14]) else None,
        float(row[15]) if is_real(row[15]) else None,
        float(row[16]) if is_real(row[16]) else None,
        float(row[17]) if is_real(row[17]) else None,
        float(row[18]) if is_real(row[18]) else None,
        float(row[19]) if is_real(row[19]) else None,
        float(row[20]) if is_real(row[20]) else None,
        float(row[21]) if is_real(row[21]) else None,
        float(row[22]) if is_real(row[22]) else None,
        float(row[23]) if is_real(row[23]) else None,
        float(row[24]) if is_real(row[24]) else None,
    ]
